...
// Route to get files by course number
router.get('/files', async (req, res) => {
    const { courseNumber } = req.query; // Get course number from query

    try {
        const files = await File.find({ courseNumber }); // Find files by course number
